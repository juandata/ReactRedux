...
This is a basic template to get started with React, Node, Express, Redux and Webpack.

# Architecture

This is a full stack web application using React, Node.js and Webpack. It is also configured with webpack-dev-server, eslint, prettier and babel.
